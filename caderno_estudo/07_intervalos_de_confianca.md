# 07 — Intervalos de Confiança (IC) 🔴 PRIORITÁRIO

> **Pré-requisito:** [estimação pontual](06_estimacao_pontual.md).
...
> **Bónus (relação IC ↔ teste):** a alínea (b) pergunta se $\mu=90$ é plausível. Como $90\notin]90{,}31;99{,}69[$, **rejeita-se** $H_0:\mu=90$ a 5% (ver [testes de hipóteses](08_testes_de_hipoteses.md)).
