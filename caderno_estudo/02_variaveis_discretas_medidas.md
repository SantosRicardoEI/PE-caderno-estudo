# 02 — Variáveis Aleatórias Discretas e Medidas

> **Pré-requisito:** [conceitos base](01_variaveis_aleatorias_conceitos_base.md).
> **A seguir:** [distribuições discretas](03_distribuicoes_discretas.md).
...
- **Ex. 43** — $E(X)$, moda, mediana e variância de uma Binomial (usa também [ficheiro 03](03_distribuicoes_discretas.md)).
