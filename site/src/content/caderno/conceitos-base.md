---
titulo: "Conceitos base de variáveis aleatórias"
ordem: 1
prioridade: "media"
tempo: "30 min"
icone: "🎲"
resumo: "Variável aleatória, função de distribuição, discreta/contínua e amostragem."
...
> **Ligação:** [medidas de v.a. discretas](/variaveis-discretas) · [v.a. contínuas](/variaveis-continuas)
...
- **Confundir `<` com `≤` em v.a. discretas.** Numa discreta, $P(X<a) = P(X \le a) - P(X=a)$. Numa **contínua**, `<` e `≤` dão o mesmo resultado (ver [ficheiro 04](/variaveis-continuas)).
