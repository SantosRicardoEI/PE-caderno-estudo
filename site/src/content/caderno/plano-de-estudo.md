---
titulo: "Plano de estudo + estratégia de 90 min"
ordem: 12
prioridade: "none"
tempo: "20 min"
icone: "🗺️"
resumo: "Ordem de estudo e gestão do tempo no teste."
...
1. [01 — Conceitos base](/conceitos-base) — `F_X`, discreta vs contínua, `<`/`≤`.
2. [02 — Medidas discretas](/variaveis-discretas) — $E$, $V$, quantis.
3. [10 — Formulário e tabelas](/formulario-e-tabelas) — **aprende a ler as tabelas cedo**; usa-las em tudo.

### Fase 2 — Distribuições e TLC 🔴 (~3h)
4. [03 — Distribuições discretas](/distribuicoes-discretas) — Binomial, Poisson.
5. [04 — Contínuas e Normal](/variaveis-continuas) — padronização (crítico!).
6. [05 — TLC](/teorema-limite-central) — resolve a Pergunta 1 sozinho.

### Fase 3 — Inferência 🔴 (~4h, o coração do teste)
7. [06 — Estimação pontual](/estimacao-pontual) — MV, $s^2$ prática.
8. [07 — Intervalos de confiança](/intervalos-de-confianca) — as 4 situações.
9. [08 — Testes de hipóteses](/testes-de-hipoteses) — 5 passos, valor-p.
10. [09 — Ajustamento e regressão](/ajustamento-e-regressao) — normalidade, interpretar R.

### Fase 4 — Treino final (~2h)
11. [11 — Exercícios tipo-teste](/exercicios-resolvidos) — resolve tudo tapando as soluções.
...
1. 🔴 **[07 — Intervalos de confiança](/intervalos-de-confianca)** (as 4 situações + escolha).
2. 🔴 **[08 — Testes de hipóteses](/testes-de-hipoteses)** (5 passos + valor-p).
3. 🔴 **[05 — TLC](/teorema-limite-central)** (receita da Pergunta 1).
4. 🔴 **[04 — Normal](/variaveis-continuas)** (padronização).
5. **[10 — Tabelas](/formulario-e-tabelas)** (ler $\Phi$, $t$, $\chi^2$).
6. **[09 — Normalidade + interpretar R](/ajustamento-e-regressao)** (Pergunta 4).
