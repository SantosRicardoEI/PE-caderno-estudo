...
- ⚠️ **Não há tabela de Poisson** nas folhas de consulta (só há tabela da Binomial, Normal, $t$ e $\chi^2$). A Poisson calcula-se **à mão** com $e^{-\lambda}$ — tem a calculadora à mão e usa o complementar para "pelo menos".
