...
1000 lançamentos de um dado; queremos testar se é equilibrado. $H_0:P(X=i)=\tfrac16$ (sem parâmetros a estimar → $\beta=0$, g.l. $=k-1=6-1=5$).

**Passo 1 — frequências esperadas:** $E_i=n\,p_i^0=1000\cdot\tfrac16=166{,}67$ (iguais, porque sob $H_0$ todas as faces têm $\tfrac16$).

**Passo 2 — montar a tabela e somar as contribuições:**

| face $i$ | $O_i$ | $E_i$ | $\dfrac{(O_i-E_i)^2}{E_i}$ |
|:---:|:---:|:---:|:---:|
| 1 | 174 | 166,67 | 0,322 |
| 2 | 174 | 166,67 | 0,322 |
| 3 | 154 | 166,67 | 0,963 |
...
| 5 | 154 | 166,67 | 0,963 |
| 6 | 165 | 166,67 | 0,017 |
| **Total** | **1000** | **1000** | $Q_0=\mathbf{3{,}499}$ |

**Passo 3 — decisão:** $c=F^{-1}_{\chi^2_5}(1-0{,}05)=11{,}07$ (tabela). Como $Q_0=3{,}499<11{,}07$, $Q_0\notin RC$ → **não se rejeita** $H_0$: os dados são compatíveis com um dado equilibrado. Valor-p $=P(Q_0>3{,}499)=0{,}6235$ (alto → não rejeitar).

> **Verificação da validade:** todos os $E_i=166{,}67\ge5$ ✓ — não é preciso agrupar classes.
