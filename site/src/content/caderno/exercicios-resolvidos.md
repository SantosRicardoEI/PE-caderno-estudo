...
Dado equilibrado? 300 lançamentos, $O=(43,49,56,45,66,41)$. $H_0:p_i=\tfrac16$, $\beta=0$, g.l. $=5$, $\alpha=10\%$.
- $E_i=300/6=50$ (todas).
- $Q_0=\sum\frac{(O_i-50)^2}{50}=\frac{49+1+36+25+256+81}{50}=\frac{448}{50}=8{,}96$.
- $c=F^{-1}_{\chi^2_5}(0{,}90)=9{,}236$. Como $8{,}96<9{,}236$ ⇒ **não se rejeita** (compatível com dado equilibrado) ✓.
